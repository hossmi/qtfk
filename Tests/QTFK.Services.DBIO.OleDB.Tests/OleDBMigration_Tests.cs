...
namespace QTFK.Services.DBIO.OleDB.Tests
{
    ...
    public class OleDBMigration_Tests
    {
        ...
        public OleDBMigration_Tests()
        {
            ...
            this._db = new OleDBIO(this._connectionString);
        ...
        public void Drop()
        {
            this._createDrop.OleDB_Drop_tables();
            IDBMigrator migrator = new OleDBMigrator(this._db, new DefaultDBMigrationStepProvider(Enumerable.Empty<IDBMigrationStep>()));
        ...
        {
            IDBMigrator migrator = new OleDBMigrator(this._db, new DefaultDBMigrationStepProvider(GetMigrations()));
            ...
            migrator = new OleDBMigrator(this._db, new BadMigrationProvider());
